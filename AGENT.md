...
Built for the [UN SDG AI Analytics Platform](README.md). This document covers the database (Layer 1) and the AI agent (Layer 2) — the part of the project that answers the users questions.
